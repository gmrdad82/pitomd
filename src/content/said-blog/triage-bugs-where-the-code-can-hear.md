...
description: "Bug pages that reference the design notes — triage that leaves a trail better than labels."
published: false
pubDate: 2026-12-08
---
...
The bug page references the design note that made the tradeoff. Triage
stops being archaeology: read the page, hit `r`, and the original
...
![A page citing the lines behind the behavior](/said-and-done/shots/card.png)

_The bug and the design decision that spawned it, on one sheet._

## Your agent does the sweep

Over MCP: "file a page per FIXME under src/, referencing each line."
Twenty minutes of grunt work, done under the agent's own name, reviewable
on the record before you accept any of it.
