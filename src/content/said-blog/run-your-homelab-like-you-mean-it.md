...
## A card per service, notes per box
...
Fixed something at 2am? One comment on the card before bed — even three
...
_The blast radius, visible: which notes — and which cards — hang off the box you're about to reboot._

## Upgrades stop being roulette

The upgrade card cites the release notes lines that matter; the thread
