...
paragraphs, work the board, and sign everything it does. A phone client,
...
Each of those gets its own post soon, because each deserves more than a
bullet.
...
up is its own side of the desk: the pages, comments, and attachments, in a
...
four-euros-and-change way to say thanks — a story for another post.
